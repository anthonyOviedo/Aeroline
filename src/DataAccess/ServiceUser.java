...
public class ServiceUser extends Service {
    ...
    private static final String INSERTTUSER = "{call lab01_proc_ins_user(?,?,?)}";
    ...
    public void insertUser(User user) throws GlobalException, NoDataException {
        ...
        try {
            pstmt = conexion.prepareCall(INSERTTUSER);
    ...
    public void deleteUser(int user_id) throws GlobalException, NoDataException, SQLException {
            try {
            conectar();
        } catch (ClassNotFoundException e) {
            throw new GlobalException("No se ha localizado el driver");
